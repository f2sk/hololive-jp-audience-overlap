...
風真いろはと他タレントとのペアJaccard係数（規模補正済み）。$|A \cap B|/|A \cup B|$ で計算し、両タレントの規模差に依存しない結合強度を示す。順位は全595ペア中の順位。

![Jaccard 上位10](../../data/plots/jp/individual_iroha/jaccard_top10.png)

| 順位 | タレント | ユニット | Jaccard | 共視聴者数 |
|---:|---|---|---:|---:|
| 21 | AZKi | 0期生 | 11.85% | 2,482 |
| 29 | 大神ミオ | ゲーマーズ | 11.14% | 2,248 |
| 83 | 雪花ラミィ | 5期生 | 9.65% | 1,867 |
| 86 | 百鬼あやめ | 2期生 | 9.54% | 2,126 |
| 99 | 大空スバル | 2期生 | 9.40% | 2,532 |
| 109 | 白上フブキ | 1期生 | 9.26% | 1,653 |
| 144 | 水宮枢 | FLOW GLOW | 8.75% | 1,721 |
| 145 | 夏色まつり | 1期生 | 8.71% | 1,604 |
| 154 | 猫又おかゆ | ゲーマーズ | 8.61% | 1,968 |
| 156 | 星街すいせい | 0期生 | 8.58% | 2,577 |

### 2.2 視聴者共有率上位と 視聴者共有率 × Jaccard 散布図

**風真いろは視点での他タレントへの視聴者共有率** = $|A \cap B|/|A|$、すなわち「風真いろはの参加者のうち、当該タレント B にも参加した割合」。**視聴者共有率は B の規模に比例するため、絶対値は B が大規模であるほど自然に高くなる**。以下の散布図では、視聴者共有率（X軸）と Jaccard（Y軸）を同時にプロットする。**右方向に位置 = 規模効果で視聴者共有率が押し上げられている**、**上方向に位置 = 規模補正済みでも強い結合** と読める。

![視聴者共有率 × Jaccard 散布図](../../data/plots/jp/individual_iroha/metric_scatter.png)
...
|---|---:|---:|---:|
| 2018年以前(7年超) | 13 | 64.2% | 8.62% |
| 2019-2020(5-7年) | 11 | 49.1% | 7.33% |
| 2021-2023(2-5年) | 6 | 36.7% | 6.76% |
...
| 大(200-300万) | 8 | 56.4% | 8.24% |
| 中(100-200万) | 19 | 63.2% | 7.76% |
| 小(50-100万) | 5 | 33.6% | 7.03% |
...
- 雪花ラミィ（5期生）J=9.65%, 順位83
- 百鬼あやめ（2期生）J=9.54%, 順位86
- 大空スバル（2期生）J=9.40%, 順位99
- 白上フブキ（1期生）J=9.26%, 順位109
- 水宮枢（FLOW GLOW）J=8.75%, 順位144
- 夏色まつり（1期生）J=8.71%, 順位145
- 猫又おかゆ（ゲーマーズ）J=8.61%, 順位154
- 星街すいせい（0期生）J=8.58%, 順位156

### 4.3 外れ値度（平均Jaccard）

- 風真いろはの他34名との平均Jaccard: **7.72%**
...
- 専属ファンは 26.2%、平均複推し数は 5.96人。
- Jaccard 最高ペアは AZKi（11.85%、全595ペア中21位）。
- 視聴者共有率絶対数では人気古参（星街すいせい 25.0%、大空スバル 24.5%）が上位だが、Jaccard では同世代・同規模タレント（AZKi、大神ミオ）が上位。
- ハブ性指標は弱め（上位30以内ペアは 2 組）、
  平均Jaccard 7.72% は35名中 22 位（小さい順）。
